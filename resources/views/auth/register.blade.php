...
<div class="text-orange-400 md:w-1/2 xl:w-1/4 m-auto mb-10 text-center mt-5">
    ...
    <div class="text-center text-gray-700">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <button type="submit"
                class="block m-auto bg-transparent mt-5 hover:bg-orange-300 text-orange-500 font-semibold hover:text-white py-2 px-4 border border-orange-300 hover:border-transparent rounded">{{ __('Register') }}</button>
        </form>
    </div>
</div>
@endsection
