...
<body>
  <div id="app">
    <header>
              ...
              <li class="p-5 lg:p-0 lg:inline lg:mr-6"><a href="{{ route('news.index') }}">News</a></li>
                ...
                <li class="p-5 lg:p-0 lg:inline">
                  ...
                  <a class="ml-5 login-mobile sm:hidden" href="">
                    <svg class="inline fill-current" xmlns='http://www.w3.org/2000/svg' width='28' height='28' viewBox='0 0 512 512'>
      ...
      <!-- Modals -->
      <div id="modal_container" style="z-index:-1;" class="w-full opacity-0 transition duration-500 h-full fixed top-0 left-0 bg-black bg-opacity-75 z-40 flex flex-col items-center justify-center">
        <div id="modal_login" style="z-index:-1;" class="w-full opacity-0 transition duration-500 relative sm:w-1/2 lg:w-1/3 xl:w-1/4 h-full my-32 bg-white text-orange-400">
          <div class="close-modal cursor-pointer absolute top-0 right-0 text-4xl mr-3">
            &#215;
          </div>
          <svg class="block m-auto mt-10 fill-current" xmlns='http://www.w3.org/2000/svg' width='100' height='100' viewBox='0 0 512 512'>
            <path d='M258.9,48C141.92,46.42,46.42,141.92,48,258.9,49.56,371.09,140.91,462.44,253.1,464c117,1.6,212.48-93.9,210.88-210.88C462.44,140.91,371.09,49.56,258.9,48ZM385.32,375.25a4,4,0,0,1-6.14-.32,124.27,124.27,0,0,0-32.35-29.59C321.37,329,289.11,320,256,320s-65.37,9-90.83,25.34a124.24,124.24,0,0,0-32.35,29.58,4,4,0,0,1-6.14.32A175.32,175.32,0,0,1,80,259C78.37,161.69,158.22,80.24,255.57,80S432,158.81,432,256A175.32,175.32,0,0,1,385.32,375.25Z'/>
            <path d='M256,144c-19.72,0-37.55,7.39-50.22,20.82s-19,32-17.57,51.93C191.11,256,221.52,288,256,288s64.83-32,67.79-71.24c1.48-19.74-4.8-38.14-17.68-51.82C293.39,151.44,275.59,144,256,144Z'/>
          </svg>
          <div class="text-center text-gray-700">
            ...
            <form action="">
              @csrf
              <input class="bg-white focus:outline-none focus:shadow-outline border border-gray-300 rounded-lg py-2 px-4 block m-auto mt-10 mb-5 appearance-none leading-normal w-3/4" type="text" placeholder="Login">
              <input class="bg-white focus:outline-none focus:shadow-outline border border-gray-300 rounded-lg py-2 px-4 block m-auto my-5 appearance-none leading-normal w-3/4" type="password" placeholder="Password">
              <button type="submit" onclick = 'this.form.submit();' class="bg-transparent mt-5 hover:bg-orange-300 text-orange-500 font-semibold hover:text-white py-2 px-4 border border-orange-300 hover:border-transparent rounded">Login</button>
            </form>
            <div class="mt-10">
              <a class="block transition duration-200 hover:text-orange-500" href="">Forgot your password?</a>
      ...
      <footer class="text-orange-300 px-10 py-5">
        <div class="flex flex-wrap justify-around">
          <div class="text-center sm:text-left sm:mr-10 mb-10 md:mb-0 md:w-1/5">
            ...
            <span class="text-white">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quaerat totam, officiis cupiditate cum nobis tenetur illo consequatur veritatis corrupti maxime minima id. Ut, autem consequuntur magnam minus ab vitae facilis.</span>
          </div>
          <div class="text-center sm:text-left sm:mr-10 mb-10 md:mb-0 md:w-1/5">
            ...
            <div class="flex justify-center sm:justify-start">
              <div>
                <a href="#">
                  <svg class="mr-3" xmlns='http://www.w3.org/2000/svg' width='40' height='40' viewBox='0 0 512 512'>
      ...
      <div class="go-top h-5 lg:hidden bg-black fixed bottom-0 text-orange-500 text-center w-full">
        <a id="go_up" href=""><ion-icon size="large" style="transform:translateY(-5px);" name="chevron-up-outline"></ion-icon></a>
      </div>
  </div>
