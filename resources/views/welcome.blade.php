...
<section id="feedback" class="relative w-full">
  ...
  <div id="feed_width_definer" class="absolute text-white overflow-hidden top-50 inset-y-0 inset-x-0 mx-10 sm:mx-20 xl:mx-40">
    <div id="fb-container" class="h-full w-full text-white text-center" style="width:200vw;">
      <div class="h-full flex items-center">
        ...
        Rui Batista de Oliveira e Silva Rui Batista de Oliveira e Silva Rui Batista de Oliveira e Silva Rui Batista de Oliveira e Silva Rui Batista de Oliveira e Silva Rui Batista de Oliveira e Silva Rui Batista de Oliveira e Silva Rui Batista de Oliveira e Silva Rui Batista de Oliveira e Silva Rui Batista de Oliveira e Silva Rui Batista de Oliveira e Silva Rui Batista de Oliveira e Silva 
      </div>
        <div class="text-xs sm:text-base fb-item float-left text-center" >2Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tenetur quas repellendus error, tempora cumque itaque, repellat minima officia reprehenderit cum dolorem placeat nesciunt voluptatem nostrum, soluta doloremque similique a consectetur.</div>
        <div class="text-xs sm:text-base fb-item float-left text-center hidden">3Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tenetur quas repellendus error, tempora cumque itaque, repellat minima officia reprehenderit cum dolorem placeat nesciunt voluptatem nostrum, soluta doloremque similique a consectetur.</div>
        <div class="text-xs sm:text-base fb-item float-left text-center hidden">4Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tenetur quas repellendus error, tempora cumque itaque, repellat minima officia reprehenderit cum dolorem placeat nesciunt voluptatem nostrum, soluta doloremque similique a consectetur.</div>
      </div>
    </div>
    <div class="absolute text-center w-full mb-40 bottom-0">
      <a class="text-orange-500 hidden" id="stop_feed" href="#">
        <svg class="fill-current stroke-current inline" xmlns='http://www.w3.org/2000/svg' width='30' height='30' viewBox='0 0 512 512'>
  ...
  <div class="absolute text-2xl text-white top-50 inset-y-0 left-0 ml-2 sm:ml-5 xl:ml-24 flex items-center">
    <a href="#" id="feed_left" class="feed-start bg-orange-400 opacity-50 px-2 sm:px-5 pb-1 leading-8" style="border-radius: 50% 0 0 50%">
      &#8249;
    </a>
  </div>
  <div class="absolute text-2xl text-white top-50 inset-y-0 right-0 mr-2 sm:mr-5 xl:mr-24 flex items-center">
    <a href="#" id="feed_right" class="feed-start bg-orange-400 opacity-50 px-2 sm:px-5 pb-1 leading-8" style="border-radius: 0 50% 50% 0">
      &#8250;
    </a>
  </div>
</section>
